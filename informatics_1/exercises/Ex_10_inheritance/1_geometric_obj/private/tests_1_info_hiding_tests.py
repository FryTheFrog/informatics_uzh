...
INSTANCES = [
    Cone(2, 5, 3, "red", True),
    Cube(6, "blue", False),
    Cylinder(3.9, 61, "black", True),
]
TYPES = {
    GeometricObject: "public/geometric_object.py",
    Cone: "public/cone.py",
    Cube: "public/cube.py",
    Cylinder: "public/cylinder.py",
}
...
class PrivateInformationHidingTestSuite(TestCase):
    ...
    def test_static_variables(self):
        # built-int type + imported type + ABC
        predef = get_non_method_members([object, TestCase, ABC])
        for t in TYPES:
            # attributes of the _class_
            for attr_name in get_non_method_members(t):
