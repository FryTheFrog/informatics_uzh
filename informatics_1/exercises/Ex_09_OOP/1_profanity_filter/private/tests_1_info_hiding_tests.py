...
class InfoHidingTestSuite(TestCase):
    ...
    INSTANCE = ProfanityFilter(["asd"], "3")
    ...
    def test_static_variables(self):
        ...
        for attr_name in get_non_method_members(InfoHidingTestSuite.TYPE): # attributes of the _class_
            ...
            m = "@@Object instances should be independent, yet, the variable " +\
                "'{}' is defined as a shared class variable.@@".format(attr_name)
            self.fail(m)
