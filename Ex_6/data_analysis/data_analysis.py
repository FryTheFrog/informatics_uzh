def gender_class_rates(dataset):
    ...
    total = first_class_male + first_class_female + second_class_male + second_class_female + third_class_male + third_class_female
    print(total)
    ...
    return (
        (first_class_male if first_class_male > 0 else None, second_class_male if second_class_male > 0 else None, third_class_male if third_class_male > 0 else None),
        (first_class_female if first_class_female > 0 else None, second_class_female if second_class_female > 0 else None, third_class_female if third_class_female > 0 else None)
    )
