...
-Ex_12, Task 3:
  ...
  -as per Tue, 7.12. the posted implementation also reaches max score but I can't confirm that this implementation is correct, since the grading gives max score anyway
